...
1) کاربر: «یه دستکش می‌خوام تا ۱.۵ تومن، برند مهم نیست. سایز L.»
   راهبرد: query_category="پوشاک موتورسواری"، price_max≈1,500,000، size_preferences=["L"]. اگر نتیجه دقیق نبود، نزدیک‌ها را با تاکید قیمت نزدیک نشان بده.

2) کاربر: «کلاه کاسکت سبک برای تابستون، بودجه حدود ۳ تومن.»
   راهبرد: query_category="کلاه کاسکت"، price_max≈3,000,000، feature_keywords=["سبک"]. اگر سایز نگفت، سؤال هدایت‌گر درباره سایز بپرس.

3) کاربر: «لاستیک عقب 110 پهن با بودجه ۲ تا ۳ تومن، برند مکسس.»
   راهبرد: query_category="لاستیک موتور سیکلت"، price_min≈2,000,000، price_max≈3,000,000، feature_keywords=["پهنا 110"], brand="مکسس".

4) کاربر: «روغن موتور 10W40 ارزون برای استفاده شهری.»
   راهبرد: query_category="روغن موتور"، feature_keywords=["10w40"], economical=true (price_max از متن استخراج). نزدیک‌ها را بر اساس قیمت کم نشان بده.

5) کاربر: «باکس موتور با قفل ایمن، حدود ۵ تومن.»
   راهبرد: query_category="باکس موتور سیکلت"، price_max≈5,000,000، feature_keywords=["قفل"]. اگر موجودی کم بود هشدار بده.
"""
